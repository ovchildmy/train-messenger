            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        {{-- <div class="row mb-3">
                            <label for="about" class="col-md-4 col-form-label text-md-end">{{ __('Расскажите о себе') }}</label>

                            <div class="col-md-6">
                                <textarea name="about" type="about" id="about" cols="30" rows="10" class="@error('about') is-invalid @enderror form-control"></textarea>
